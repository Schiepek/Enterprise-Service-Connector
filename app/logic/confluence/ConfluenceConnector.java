...
public class ConfluenceConnector {
    ...
    private final String AUTHORIZATION_URL = Settings.getSettings().getConfluenceUrl() + "/plugins/servlet/oauth/authorize";
    private final String ACCESS_TOKEN_URL = Settings.getSettings().getConfluenceUrl() + "/plugins/servlet/oauth/access-token";
    private final String CONSUMER_KEY = APIConfig.getAPIConfig(ServiceProvider.CONFLUENCE).getClientId();
    private final String PRIVATE_KEY = APIConfig.getAPIConfig(ServiceProvider.CONFLUENCE).getClientSecret();
    private final String CALLBACK_URI = Settings.getSettings().getServerUrl() + "/confluence/callback";
